...
const TEST_FILES = [
  ...
  "lib/list/list-creation.integration.test.ts",
  "lib/list/list-lifecycle.test.ts",
  "lib/list/list-lifecycle.integration.test.ts",
  "lib/list/list-browsing.integration.test.ts",
  ...
  "lib/list/list-sections.test.ts",
  "lib/list/list-sections.integration.test.ts",
  "lib/list/list-board.test.ts",
  ...
  "lib/item/item-lifecycle.integration.test.ts",
  "lib/item/item-assignment.integration.test.ts",
  "lib/item/item-assigned-by-me.integration.test.ts",
  "lib/item/item-sharing.test.ts",
  "lib/item/item-sharing.integration.test.ts",
  "lib/item/item-labels.integration.test.ts",
  "lib/item/item-custom-fields.test.ts",
  "lib/item/item-custom-fields.integration.test.ts",
  "lib/item/item-dependencies.integration.test.ts",
  "lib/item/item-attachments.test.ts",
  "lib/item/item-attachments.integration.test.ts",
  "lib/item/item-notes.integration.test.ts",
  "lib/item/quick-add-parser.test.ts",
  "lib/item/item-quick-add.integration.test.ts",
