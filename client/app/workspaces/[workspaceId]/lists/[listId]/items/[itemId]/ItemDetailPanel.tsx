...
export function ItemDetailPanel({
  ...
  return (
    <div className="@container flex flex-col gap-6">
      ...
      {/*
        Two-track layout: primary/narrative content on the left, structured
        metadata on the right. `@lg` only activates once this panel's own
        container (not the viewport) is wide enough — the full-page detail
        view qualifies, the 380px slide-out drawer stays single-column.
      */}
      <div className="grid grid-cols-1 gap-6 @lg:grid-cols-[minmax(0,1fr)_272px] @lg:items-start @lg:gap-8">
          ...
          <div className={SECTION_CLASS}>
            ...
            {data.canEdit && unassignedMembers.length > 0 && (
              <form action={boundAddAssignee} className="flex items-center gap-2">
                <select name="userId" required defaultValue="" className={INPUT_CLASS}>
